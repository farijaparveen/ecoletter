...
<head>
    <meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge"> <link href="/favicon.png" rel="icon" type="image/x-icon" />
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Notification
                <small>Official proclamations</small>
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content">
            ...
            $dissql="SELECT * from notification WHERE role=1";
