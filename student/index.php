                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            $sql5="SELECT count(*) as counts from letter_content where status=1 AND sender=".$_SESSION['login_user'];
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                ...
                                $sql5="SELECT count(*) as counts from letter_content where status=2 AND sender=".$_SESSION['login_user'];
                                $rsql=mysqli_query($db,$sql5);
                                $row=mysqli_fetch_assoc($rsql);
                                echo $row['counts'];
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12">
                        <div class="info-box">
                            ...
                            $sql5="SELECT count(*) as counts from letter_content where status=3 AND sender=".$_SESSION['login_user'];
                            $rsql=mysqli_query($db,$sql5);
                            $row=mysqli_fetch_assoc($rsql);
                            echo $row['counts'];
