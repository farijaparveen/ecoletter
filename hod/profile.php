                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <form class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label">HOD id</label>

                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputName" placeholder="<?php echo $data['hod_id']; ?>" disabled="disabled">
                                    </div>
                                </div>
                                <div class="form-group">
