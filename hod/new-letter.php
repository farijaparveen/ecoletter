...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                New Letter<small>Create new letter</small>
            </h1>
            <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter the subject" required>
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">Leave date</label>
                                    <input type="date" class="form-control" id="exampleInputEmail1" placeholder="Enter the subject">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputEmail1">No of days leave sought</label>
                                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Enter the subject">
                                </div>
