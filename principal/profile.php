                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <p class="text-muted text-center"><?php echo $data['dept']; ?></p>
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="activity">
                                ...
                                <div class="form-group">
                                    <label for="inputName" class="col-sm-2 control-label">Principal id</label>

                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputName" placeholder="<?php echo $data['principal_id']; ?>" disabled="disabled">
                                    </div>
                                </div>
                                    <div class="form-group">
                                        <label for="inputName" class="col-sm-2 control-label">Faculty type</label>

                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="inputName" placeholder="<?php echo $data['factype']; ?>" disabled="disabled">
                                        </div>
                                    </div>
                                <div class="form-group">
