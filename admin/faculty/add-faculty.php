            ...
            <form class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="facname" placeholder="Name of the Faculty">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="facid" name="facid" placeholder="ID of the faculty">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="number" class="form-control" id="mobno" name="mobno" placeholder="Mobile number of the faculty">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" id="email" name="mailid" placeholder="Mail id of the faculty">
                  </div>
                </div>
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="bloodgroup" name="bloodgroup" placeholder="Blood group of the faculty">
                  </div>
                </div>
